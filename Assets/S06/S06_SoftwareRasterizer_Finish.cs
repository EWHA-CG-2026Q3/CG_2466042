...
public class S06_SoftwareRasterizer_Finish : MonoBehaviour
{
    ...
    [SerializeField] private Vector2 vertexA = new Vector2(210, 220);
    [SerializeField] private Vector2 vertexB = new Vector2(40, 40);
    [SerializeField] private Vector2 vertexC = new Vector2(190, 70);
    [SerializeField] private Color fillColor = new Color(0.7f, 0.5f, 1f, 1f);
